...
namespace L01P02_2020TD601.Controllers
{
    public class platosController : Controller
    {
        private readonly platosContext _context;

        public platosController(platosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.platos != null ? 
                          ...
                          Problem("Entity set 'platosContext.platos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'platosContext.platos'  is null.");
            }
            var platos = await _context.platos.FindAsync(id);
            if (platos != null)
            {
